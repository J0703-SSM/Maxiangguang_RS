...
<div id="main">
    ...
    <form action="${pageContext.request.contextPath}/role/role_modi" method="post" class="main_form">
        ...
        <div class="input_info">
            ...
            <c:choose>
                ...
                <c:otherwise>
                    <span class="required">*</span>
                    <div class="validate_msg_medium error_msg">${roleNameEr}</div>
                </c:otherwise>
            </c:choose>
        </div>
            ...
            <div class="input_info_scroll">
                <ul>
                    <c:forEach var="p" items="${privilegeList}">
                        <li><input type="checkbox" name="privilege"
                                <c:forEach var="s" items="${split}">
                                    <c:if test="${s == p.privilegeName}">checked</c:if>
                                </c:forEach>
                                   value="${p.privilegeName}"/>${p.privilegeName}</li>
                    </c:forEach>
                </ul>
            </div>
            <span class="required">*</span>
